...
export interface ParsedHostelSubpage {
...
export function parseHostelPage(html: string): ParsedHostelSubpage {
  ...
  // ── Step 2: Extract label-value pairs ───────────────────────────────────
  ...
  // Pattern 2: label + next text/input
  ...
  // Pattern 3: td label + td value in same row
  $('tr').each((_, trEl) => {
  ...
  // Pattern 4: key-value class labels
  ...
  // ── Step 3: Extract alert/status texts ──────────────────────────────────
